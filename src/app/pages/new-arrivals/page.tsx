...
import ProductGrid from "@/components/footwear/ProductGrid";
...
const mockProducts: Product[] = Array.from({ length: 12 }).map((_, i) => {
  ...
  return {
    ...
    isNew: true, // All products are new arrivals
    isSoldOut: isSoldOut,
    colorName:
      i % 3 === 0 ? "Black/White" : i % 3 === 1 ? "Stadium Green" : "Beige",
    tags: ["New Arrival", "SS25"],
  };
});
    ...
    return mockProducts.filter((product) => {
      ...
      const sizeMatch =
        ...
        product.variants.some((variant) => {
          const size = variant.title?.replace("EU ", "") || "";
